...
from satchmo.configuration import config_get, config_get_group, \
    config_register_list, DecimalValue, MultipleStringValue
...
config_register_list(
    DecimalValue(SHIPPING_GROUP,
                 'PACKING_FEE',
                 description=_("[Royal Mail Contract] Packing Fee"),
    ...
    DecimalValue(SHIPPING_GROUP,
                 'PER_KG_EU',
                 description=_("[Royal Mail Contract] Per Kg price E.U."),
                 requires=SHIP_MODULES,
                 requiresvalue='satchmo.shipping.modules.royalmailcontract',
                 default="4.33"),
    ...
    DecimalValue(SHIPPING_GROUP,
                 'PER_RATE_ROW',
                 description=_("[Royal Mail Contract] Per item price R.o.W."),
                 requires=SHIP_MODULES,
                 requiresvalue='satchmo.shipping.modules.royalmailcontract',
                 default="1.14"),
    ...
    DecimalValue(SHIPPING_GROUP,
                 'PER_KG_ROW',
                 description=_("[Royal Mail Contract] Per Kg price R.o.W."),
                 requires=SHIP_MODULES,
                 requiresvalue='satchmo.shipping.modules.royalmailcontract',
                 default="6.65"),

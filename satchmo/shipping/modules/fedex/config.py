...
SHIP_MODULES.add_choice(('satchmo.shipping.modules.fedex', 'FEDEX'))

SHIPPING_GROUP = ConfigurationGroup('satchmo.shipping.modules.fedex',
  _('FedEx Shipping Settings'),
  requires = SHIP_MODULES,
  requiresvalue='satchmo.shipping.modules.fedex',
  ordering = 101
)

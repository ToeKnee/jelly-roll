...
SHIP_MODULES.add_choice(('satchmo.shipping.modules.usps', 'USPS'))

SHIPPING_GROUP = ConfigurationGroup('satchmo.shipping.modules.usps',
...
#    hidden=True,
#    default = 'satchmo.shipping.modules.ups'),

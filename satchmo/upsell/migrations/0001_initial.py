    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goal', models.ForeignKey(related_name='upsellgoals', verbose_name='Goal Product', to='product.Product')),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Upsell'
        db.create_table('upsell_upsell', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('goal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='upsellgoals', to=orm['product.Product'])),
            ('create_date', self.gf('django.db.models.fields.DateField')()),
            ('style', self.gf('django.db.models.fields.CharField')(default='CHECKBOX_1_FALSE', max_length=20)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('upsell', ['Upsell'])

        # Adding M2M table for field target on 'Upsell'
        db.create_table('upsell_upsell_target', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('upsell', models.ForeignKey(orm['upsell.upsell'], null=False)),
            ('product', models.ForeignKey(orm['product.product'], null=False))
        ))
        db.create_unique('upsell_upsell_target', ['upsell_id', 'product_id'])

        # Adding model 'UpsellTranslation'
        db.create_table('upsell_upselltranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('menu', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['upsell.Upsell'])),
            ('languagecode', self.gf('django.db.models.fields.CharField')(default='ar', max_length=10)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('upsell', ['UpsellTranslation'])


    def backwards(self, orm):
        
        # Deleting model 'Upsell'
        db.delete_table('upsell_upsell')

        # Removing M2M table for field target on 'Upsell'
        db.delete_table('upsell_upsell_target')

        # Deleting model 'UpsellTranslation'
        db.delete_table('upsell_upselltranslation')
    ...
    models = {
        ...
        'product.product': {
            ...
            'date_added': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2010, 11, 4, 13, 39, 48, 333668)'}),
        ...
        'upsell.upsell': {
            'Meta': {'object_name': 'Upsell'},
            'create_date': ('django.db.models.fields.DateField', [], {}),
            'goal': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'upsellgoals'", 'to': "orm['product.Product']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'style': ('django.db.models.fields.CharField', [], {'default': "'CHECKBOX_1_FALSE'", 'max_length': '20'}),
            'target': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'upselltargets'", 'symmetrical': 'False', 'to': "orm['product.Product']"})
        },
        'upsell.upselltranslation': {
            'Meta': {'object_name': 'UpsellTranslation'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'languagecode': ('django.db.models.fields.CharField', [], {'default': "'ar'", 'max_length': '10'}),
            'menu': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'to': "orm['upsell.Upsell']"})
        }
    }

    complete_apps = ['upsell']

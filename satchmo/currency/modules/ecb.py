...
class EcbExchangeRateClient(object):
    ...
    def update_exchange_rates(self):
        ...
        if primary_currency.iso_4217_code == 'EUR':
            ...
            try:
                euro_exchange_rate = converter.convert(1.0, primary_currency.iso_4217_code)
            except ValueError:
        ...
        for currency in accepted_currencies:
            if currency.iso_4217_code == 'EUR':
                ...
                try:
                    rate = 1 / converter.convert(1, currency.iso_4217_code) * euro_exchange_rate
                except ValueError:
                    continue

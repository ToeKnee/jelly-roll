    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.ImageField(
                upload_to='product-category/', max_length=200, verbose_name='Picture'),
        ...
        migrations.AlterField(
            ...
            field=models.TextField(default='', help_text='Additional information about the product to appear below the fold.',
                                   verbose_name='Enhanced description of product', blank=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, max_length=10, null=True,
                                   verbose_name='language', choices=[(b'en', b'English')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            ...
            name='picture',
            field=models.ImageField(
                upload_to='products/', max_length=200, verbose_name='Picture'),
            preserve_default=True,
        ),
        migrations.AlterField(

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('product_product', (
            ...
            ('date_added', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2010, 11, 4, 13, 33, 20, 819354))),
    ...
    models = {
        ...
        'product.product': {
            ...
            'date_added': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2010, 11, 4, 13, 33, 20, 819354)'}),

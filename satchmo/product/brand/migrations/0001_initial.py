    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Used for URLs',
            ...
            bases=(models.Model, satchmo.l10n.mixins.TranslatedObjectMixin),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(
                    verbose_name='Full Description', blank=True)),
                ('picture', models.ImageField(max_length=200,
                                              null=True, verbose_name='Picture', blank=True)),
                ('brand', models.ForeignKey(related_name='translations',
                                            to='brand.Brand', on_delete=models.CASCADE)),
            ],
            options={

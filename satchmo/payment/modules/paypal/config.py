...
config_register_list(
    ...
    StringValue(
        PAYMENT_GROUP, "WEBHOOK_ID", description=_("Live Webhook ID"), default="xxx"
    ),
    StringValue(
        PAYMENT_GROUP,
        "SANDBOX_WEBHOOK_ID",
    ...
    StringValue(
        PAYMENT_GROUP, "SECRET_KEY", description=_("Live Secret key"), default="xxx"
    ),
    StringValue(
        PAYMENT_GROUP, "CLIENT_ID", description=_("Live Client ID"), default="xxx"
    ),
    StringValue(
        PAYMENT_GROUP,
        "SANDBOX_SECRET_KEY",
    ...
    StringValue(
        PAYMENT_GROUP, "KEY", description=_("Module key"), hidden=True, default="PAYPAL"
    ),
    StringValue(
        PAYMENT_GROUP,
        "URL_BASE",

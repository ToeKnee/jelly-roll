...
config_register_list(
    ...
    BooleanValue(
        ...
        help_text=_(
            "Enable payment tokenisation (Alias Manager). If the alias exists, the cardholder name, masked credit card number (or account information) and expiry date will be initialised in the payment details page for validation."
        ),
        default=False,
    ),
    StringValue(

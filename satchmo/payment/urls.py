...
urlpatterns = patterns('satchmo.payment.views',
                       ...
                       (r'^balance/(?P<order_id>\d+)/$', 'balance.balance_remaining_order', {}, 'satchmo_balance_remaining_order'),
                       (r'^balance/$', 'balance.balance_remaining', {}, 'satchmo_balance_remaining'),
                       (r'^cron/$', 'cron.cron_rebill', {}, 'satchmo_cron_rebill'),
                       (r'^mustlogin/$', 'contact.authentication_required', {}, 'satchmo_checkout_auth_required'),
                       )

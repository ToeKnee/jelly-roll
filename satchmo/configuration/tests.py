...
class TestMultipleValues(TestCase):
    def setUp(self):
        ...
        self.g1c1 = config_register(
            MultipleStringValue(
                g1, "c1", choices=((1, "one"), (2, "two"), (3, "three"))
            )
        )
...
class TestMultipleValuesWithDefault(TestCase):
    def setUp(self):
        ...
        self.g1c1 = config_register(
            MultipleStringValue(
                g1, "c1", choices=((1, "one"), (2, "two"), (3, "three")), default=[1, 2]
            )
        )
...
class ConfigTestRequiresValue(TestCase):
    def setUp(self):
        ...
        self.g1c1 = config_register(
            IntegerValue(g1, "c1", requires=choices1, requiresvalue="foo", ordering=3)
        )
        self.g1c2 = config_register(
            IntegerValue(g1, "c2", requires=choices1, requiresvalue="bar", ordering=4)
        )
        self.g1c3 = config_register(IntegerValue(g1, "c3", ordering=5))
        ...
        self.g2c1 = config_register(
            IntegerValue(g2, "c1", requires=choices2, requiresvalue="a", ordering=3)
        )
        self.g2c2 = config_register(
            IntegerValue(g2, "c2", requires=choices2, requiresvalue="b", ordering=4)
        )
        self.g2c3 = config_register(
            IntegerValue(g2, "c3", requires=choices2, requiresvalue="c", ordering=5)
        )
...
class ConfigTestGroupRequires(TestCase):
    def setUp(self):
        ...
        g1 = ConfigurationGroup(
            "groupreq", "Requirements 4", ordering=1000, requires=choices1
        )
        self.g1 = g1

        self.g1c1 = config_register(IntegerValue(g1, "c1", ordering=3))
        self.g1c2 = config_register(
            IntegerValue(g1, "c2", requires=choices2, requiresvalue="bar", ordering=4)
        )
        self.g1c3 = config_register(IntegerValue(g1, "c3", ordering=5))

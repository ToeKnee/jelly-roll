...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('code', models.CharField(unique=True, max_length=2, verbose_name='2 letter code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eu', models.BooleanField(default=False, verbose_name='Country is a member of the European Union')),
                ('continent', models.ForeignKey(to='l10n.Continent', to_field=b'code')),
            ],
            options={
                'ordering': ('name',),

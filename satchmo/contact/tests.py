...
class ContactInfoFormL10NTestCA(TestCase):
    ...
    def test_invalid_province(self):
        ...
        data = {
            'email': 'test_email@satchmoproject.com', 'first_name': 'Test', 'last_name': 'McTestalot', 'phone': '123-111-4411',
            'street1': "301 Front Street West", 'city': "Toronto", 'state': "NY", 'postal_code': "M5V 2T6", 'country': self.ca.id,
            'ship_street1': "301 Front Street West", 'ship_city': "Toronto", 'ship_state': "NY", 'ship_postal_code': "M5V 2T6", 'ship_country': self.ca.id
        }
        form = ContactInfoForm(data, shop=self.shop, contact=contact)
        self.assertEqual(False, form.is_valid(), form.errors)
        self.assertEqual(form.errors, {

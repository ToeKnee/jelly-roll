    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postal_code', models.CharField(max_length=30, verbose_name='Post Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, max_length=20, null=True, verbose_name='Role', choices=[(b'Customer', 'Customer'), (b'Supplier', 'Supplier'), (b'Distributor', 'Distributor')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('type', models.CharField(max_length=30, verbose_name='Type', choices=[(b'Email', 'Email'), (b'Phone', 'Phone'), (b'In Person', 'In Person')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=30, verbose_name='Type', choices=[(b'Company', 'Company'), (b'Government', 'Government'), (b'Non-profit', 'Non-profit')])),
                ('role', models.CharField(max_length=30, verbose_name='Role', choices=[(b'Supplier', 'Supplier'), (b'Distributor', 'Distributor'), (b'Manufacturer', 'Manufacturer'), (b'Customer', 'Customer')])),
                ('create_date', models.DateField(verbose_name='Creation Date')),

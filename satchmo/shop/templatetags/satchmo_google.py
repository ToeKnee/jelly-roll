...
register.inclusion_tag("google-analytics/receipt.html",
                       takes_context=True)(show_receipt)
...
register.inclusion_tag("google-analytics/signup.html",
                       takes_context=True)(google_track_signup)
...
register.inclusion_tag("google-analytics/adwords_conversion.html",
                       takes_context=True)(google_adwords_sale)
...
register.inclusion_tag("google-analytics/adwords_conversion.html",
                       takes_context=True)(google_adwords_signup)

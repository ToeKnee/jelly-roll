...
class ConfigOptions(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            _("Shipping Countries"),
            {"fields": ("in_country_only", "sales_country", "shipping_countries")},
        ),
    )
...
class OrderStatusListFilter(admin.SimpleListFilter):
    ...
    def lookups(self, request, model_admin):
        ...
        return (
            ...
            for status in Status.objects.all().order_by("status")
        )
...
class OrderOptions(admin.ModelAdmin):
        ...
        (
            _("Shipping Information"),
            {
                "fields": (
                    ...
                    "shipping_date",
                    "estimated_delivery_min_date",
                    "estimated_delivery_expected_date",
                    "estimated_delivery_max_date",
                )
            },
        ),
        (
    ...
    def shipped(self, request, queryset):
        ...
        for obj in queryset:
            ...
            obj.add_status(status=shipped_status, notes="Thanks for your order")
            rows_updated += 1
        if rows_updated == 1:
...
class OrderPaymentOptions(admin.ModelAdmin):
    ...
    search_fields = [
        ...
        "amount",
        "order__id",
        "order__contact__user__email",
        "order__contact__first_name",
        "order__contact__last_name",
        "order__contact__email",
    ]

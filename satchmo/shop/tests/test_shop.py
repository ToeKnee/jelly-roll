...
class ShopTest(TestCase):
    ...
    def test_get_price(self):
        ...
        response = self.client.post(
            prefix + "/product/dj-rocks/prices/", {"1": "S", "2": "B", "quantity": 1}
        )
        ...
        response = self.client.post(
            prefix + "/product/dj-rocks/prices/", {"1": "L", "2": "BL", "quantity": 2}
        )
        content = response.content.split(",")
    ...
    def test_contact_form(self):
        ...
        self.assertContains(
            response, "<h3>Contact Information</h3>", count=1, status_code=200
        )
        response = self.client.post(
            prefix + "/contact/",
            {

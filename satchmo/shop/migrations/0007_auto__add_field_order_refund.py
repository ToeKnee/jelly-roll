...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.refund'
        db.add_column('shop_order', 'refund', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=10, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.refund'
        db.delete_column('shop_order', 'refund')
    ...
    models = {
        ...
        'shop.downloadlink': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 25, 21, 21, 4, 972769)'})
        },
        'shop.order': {
        ...
        'shop.orderpayment': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 25, 21, 21, 4, 974253)'}),

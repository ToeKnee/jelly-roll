...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orders = orm['shop.order'].objects.filter(status__isnull=False).exclude(status__status__status="Pending")
        orders.update(frozen=True)
    ...
    models = {
        ...
        'shop.downloadlink': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 5, 21, 34, 30, 221197)'})
        },
        'shop.order': {
        ...
        'shop.orderpayment': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 5, 21, 34, 30, 223167)'}),
        ...
        'shop.orderstatus': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 5, 21, 34, 30, 222252)'})
        },
        'shop.ordertaxdetail': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.frozen'
        db.add_column('shop_order', 'frozen', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.frozen'
        db.delete_column('shop_order', 'frozen')
    ...
    models = {
        ...
        'shop.downloadlink': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 5, 21, 33, 31, 711154)'})
        },
        'shop.order': {
        ...
        'shop.orderpayment': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 5, 21, 33, 31, 716673)'}),
        ...
        'shop.orderstatus': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 5, 21, 33, 31, 712155)'})
        },
        'shop.ordertaxdetail': {

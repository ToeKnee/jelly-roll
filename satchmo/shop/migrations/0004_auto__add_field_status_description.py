...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_status', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Status.description'
        db.delete_column('shop_status', 'description')
    ...
    models = {
        ...
        'product.product': {
            ...
            'date_added': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2010, 11, 26, 15, 39, 51, 443642)'}),
        ...
        'shop.downloadlink': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 26, 15, 39, 51, 845254)'})
        },
        'shop.order': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 26, 15, 39, 51, 840910)'}),
        ...
        'shop.orderpayment': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 26, 15, 39, 51, 847129)'}),
        ...
        'shop.orderstatus': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 26, 15, 39, 51, 846126)'})
        },
        'shop.ordertaxdetail': {

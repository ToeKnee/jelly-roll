    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_change', models.DecimalField(null=True, verbose_name='Item Detail Price Change', max_digits=6, decimal_places=2, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postal_code', models.CharField(max_length=9, null=True, verbose_name='Post Code', blank=True)),
                ('phone', models.CharField(max_length=12, null=True, verbose_name='Phone Number', blank=True)),
                ('no_stock_checkout', models.BooleanField(default=True, verbose_name='Purchase item not in stock?')),
                ('in_country_only', models.BooleanField(default=True, verbose_name='Only sell to in-country customers?')),
                ('country', models.ForeignKey(verbose_name='Country', blank=True, to='l10n.Country')),
                ('sales_country', models.ForeignKey(related_name='sales_country', verbose_name=b'Default country for customers', blank=True, to='l10n.Country', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_stamp', models.DateTimeField(default=datetime.datetime.now, verbose_name='Time stamp')),
                ('active', models.BooleanField(default=True, verbose_name='Active')),
                ('downloadable_product', models.ForeignKey(verbose_name='Downloadable product', to='product.DownloadableProduct')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_stamp', models.DateTimeField(verbose_name='Timestamp', editable=False)),
                ('notes', models.TextField(null=True, verbose_name='Notes', blank=True)),
                ('method', models.CharField(blank=True, max_length=200, verbose_name='Order method', choices=[(b'Online', 'Online'), (b'In Person', 'In Person'), (b'Show', 'Show')])),
                ...
                ('ship_postal_code', models.CharField(max_length=30, verbose_name='Post Code', blank=True)),
                ...
                ('bill_postal_code', models.CharField(max_length=30, verbose_name='Post Code', blank=True)),
                ...
                ('sub_total', models.DecimalField(null=True, verbose_name='Subtotal', max_digits=18, decimal_places=10, blank=True)),
                ...
                ('tax', models.DecimalField(null=True, verbose_name='Tax', max_digits=18, decimal_places=10, blank=True)),
                ('discount', models.DecimalField(null=True, verbose_name='Discount amount', max_digits=18, decimal_places=10, blank=True)),
                ('total', models.DecimalField(null=True, verbose_name='Total', max_digits=18, decimal_places=10, blank=True)),
                ('refund', models.DecimalField(decimal_places=10, max_digits=18, blank=True, help_text='When refunding an order (either whole or in part), please note the amount here', null=True, verbose_name='Refund')),
                ('bill_country', models.ForeignKey(related_name='bill_country', blank=True, to='l10n.Country')),
                ('contact', models.ForeignKey(editable=False, to='contact.Contact', verbose_name='Contact')),
                ('ship_country', models.ForeignKey(related_name='ship_country', blank=True, to='l10n.Country')),
                ('site', models.ForeignKey(editable=False, to='sites.Site', verbose_name='Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('quantity', models.IntegerField(verbose_name='Quantity')),
                ('unit_price', models.DecimalField(verbose_name='Unit price', max_digits=18, decimal_places=10)),
                ('unit_tax', models.DecimalField(null=True, verbose_name='Unit tax', max_digits=18, decimal_places=10)),
                ('line_item_price', models.DecimalField(verbose_name='Line item price', max_digits=18, decimal_places=10)),
                ('tax', models.DecimalField(null=True, verbose_name='Line item tax', max_digits=18, decimal_places=10)),
                ...
                ('stock_updated', models.BooleanField(default=False, verbose_name='Stock Updated')),
                ('discount', models.DecimalField(null=True, verbose_name='Line item discount', max_digits=18, decimal_places=10, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_change', models.DecimalField(null=True, verbose_name='Price Change', max_digits=18, decimal_places=10, blank=True)),
                ('sort_order', models.IntegerField(help_text='The display order for this group.', verbose_name='Sort Order')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('payment', satchmo.payment.fields.PaymentChoiceCharField(blank=True, max_length=25, choices=[(b'PAYMENT_PAYPAL', 'PayPal'), (b'PAYMENT_WORLDPAY', 'Credit / Debit card (WorldPay)')])),
                ('amount', models.DecimalField(null=True, verbose_name='amount', max_digits=18, decimal_places=10, blank=True)),
                ('time_stamp', models.DateTimeField(default=datetime.datetime.now, verbose_name='timestamp')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_stamp', models.DateTimeField(verbose_name='Timestamp', editable=False, db_index=True)),
                ('order', models.ForeignKey(verbose_name='Order', to='shop.Order')),
            ],
            options={
                'ordering': ('time_stamp',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notify', models.BooleanField(default=True, help_text=b'Notify the user on status update', verbose_name='Notify')),
                ('display', models.BooleanField(default=True, help_text=b'Show orders of this status in the admin area home page', verbose_name='Display')),
            ],
            options={
                'verbose_name': 'Status',
        ...
        migrations.AddField(
            ...
            name='status',
            field=models.ForeignKey(verbose_name='Status', to='shop.Status'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='order',
            name='status',
            field=models.ForeignKey(related_name='current_status', blank=True, editable=False, to='shop.OrderStatus', null=True),
            preserve_default=True,
        ),
        migrations.AddField(

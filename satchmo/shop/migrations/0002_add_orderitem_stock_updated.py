...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.stock_updated'
        db.add_column('shop_orderitem', 'stock_updated', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.stock_updated'
        db.delete_column('shop_orderitem', 'stock_updated')
    ...
    models = {
        ...
        'product.product': {
            ...
            'date_added': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2010, 11, 4, 16, 11, 42, 839878)'}),
        ...
        'shop.downloadlink': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 4, 16, 11, 42, 881969)'})
        },
        'shop.order': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 4, 16, 11, 42, 877768)'}),
        ...
        'shop.orderpayment': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 4, 16, 11, 42, 884934)'}),
        ...
        'shop.orderstatus': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 4, 16, 11, 42, 883055)'})
        },
        'shop.ordertaxdetail': {

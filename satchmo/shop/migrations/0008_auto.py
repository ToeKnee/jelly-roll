...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'OrderStatus', fields ['time_stamp']
        db.create_index('shop_orderstatus', ['time_stamp'])


    def backwards(self, orm):
        
        # Removing index on 'OrderStatus', fields ['time_stamp']
        db.delete_index('shop_orderstatus', ['time_stamp'])
    ...
    models = {
        ...
        'shop.config': {
            ...
            'no_stock_checkout': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'shop.downloadlink': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 7, 21, 47, 21, 763541)'})
        },
        'shop.order': {
            ...
            'refund': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '18', 'decimal_places': '10', 'blank': 'True'}),
        ...
        'shop.orderitem': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['product.Product']"}),
            'quantity': ('django.db.models.fields.IntegerField', [], {}),
            'stock_updated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'shop.orderpayment': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 7, 21, 47, 21, 765228)'}),
        ...
        'shop.orderstatus': {
            ...
            'time_stamp': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'})
        },
        'shop.ordertaxdetail': {
